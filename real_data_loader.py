...
class TripletFaceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        anc_img = os.path.join(
            self.root_dir, str(pos_name), str(anc_id) + f".{anc_ext}"
        )
        pos_img = os.path.join(
            self.root_dir, str(pos_name), str(pos_id) + f".{pos_ext}"
        )
        neg_img = os.path.join(
            self.root_dir, str(neg_name), str(neg_id) + f".{neg_ext}"
        )
